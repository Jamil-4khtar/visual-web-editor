    ...
    <div>
      ...
      <div className="bg-black/30  sm:opacity-0 hover:opacity-100 absolute inset-0 hover:bg-black/50 flex flex-col sm:flex-row items-center justify-center gap-2 rounded-md transition-colors">
          <button
            ...
            className="px-4 py-2 text-sm font-medium text-gray-700 w-20 bg-gray-100 rounded-md hover:bg-gray-200 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 transition-colors"
          >
            Edit
          </button>
          <button
            onClick={() => openModal(template.content)}
            className="px-4 py-2 text-sm font-medium text-white bg-gray-800 w-20 rounded-md hover:bg-black focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-500 transition-colors"
          >
            Preview
          </button>
        </div>
