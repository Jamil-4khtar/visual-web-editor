...
function LibraryView({ templates, loading, onEdit, onCreate }) {
  if (loading) return <p className="p-4">Loading Templates...</p>;
  const handleGoBack = () => {
    window.history.back();
  };
      ...
      <div className="container mx-auto px-4 py-8">
        <div className="flex items-center justify-between mb-8">
          <div className="flex items-center gap-4">
            ...
            <h1 className="text-3xl font-bold text-gray-400">Template Library</h1>
          </div>
          <button
            onClick={onCreate}
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-8">
          {templates.map((template) => (
            ...
            >
              <div className="p-6">
                <h3 className="text-xl font-semibold text-gray-800 mb-4 truncate">{template.name}</h3>
