        ...
        <header class="bg-white/500 backdrop-blur-lg sticky top-0 z-50 shadow-sm">
          <nav class="container mx-auto px-6 py-4 flex justify-between items-center">
            ...
            <div class="hidden md:flex items-center space-x-6">
              ...
              <a
                href="#cta"
                class="bg-indigo-600 text-white font-semibold py-2 px-5 rounded-lg hover:bg-indigo-700 transition"
              >
                Launch Editor
              </a>
            </div>
        ...
        <main class="hero-gradient">
          <section class="container mx-auto px-6 py-20 md:py-32 text-center">
            <h1 class="text-4xl md:text-6xl font-extrabold text-gray-900 leading-tight">
              Build Beautiful Web Pages, <br class="hidden md:inline" />{" "}
            ...
            <div class="mt-10 flex justify-center items-center space-x-4">
              <a
                href="#cta"
                class="cta-gradient text-white font-bold py-3 px-8 rounded-full hover:shadow-xl transform hover:-translate-y-1 transition-all duration-300"
              >
                Get Started for Free
              </a>
              <a
                href="#how-it-works"
                class="bg-white text-gray-700 font-semibold py-3 px-8 rounded-full shadow-md hover:bg-gray-100 transition"
              >
                See How It Works
              </a>
            </div>
            <div class="mt-16 mx-auto max-w-5xl">
              <img
                src="https://placehold.co/1200x600/e2e8f0/4a5568?text=Editor+Screenshot"
        ...
        <section id="cta" class="cta-gradient">
          <div class="container mx-auto px-6 py-20 text-center">
            ...
            <div class="mt-8">
              <a
                href="#"
                class="bg-white text-indigo-600 font-bold py-4 px-10 rounded-full text-lg hover:bg-gray-100 transform hover:scale-105 transition-all duration-300 shadow-xl"
              >
